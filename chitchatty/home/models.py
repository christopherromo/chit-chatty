...
class WordOfTheDayTracker(models.Model):
    ...
    # Ensures that the languagesGenerated list values are all unique (no duplicates)  # noqa: E501
    ...
    def __str__(self):
        return f"List of words generated for member {self.member.userName}: {self.languagesGenerated}"  # noqa: E501
